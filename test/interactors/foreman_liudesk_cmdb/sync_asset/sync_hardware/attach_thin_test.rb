...
class AttachThinHardwareTest < ActiveSupport::TestCase
  subject do
    ForemanLiudeskCMDB::SyncAsset::SyncHardware::AttachThin.call(
      host: host
    )
  end
  ...
  context "when hardware id is assigned in the facet" do
    ...
    it "does not finds a thin hardware object if outdated" do
      host.liudesk_cmdb_facet.sync_at = Time.at(0)
